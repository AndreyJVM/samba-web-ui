...
public class GroupApiController {
  ...
  @GetMapping
  public ApiResponse<List<SambaGroup>> getAllGroups(@RequestAttribute("sessionId") String sessionId)
      throws Exception {
  ...
  public ApiResponse<Void> createGroup(
      @RequestAttribute("sessionId") String sessionId, @Valid @RequestBody SambaGroupCreateDto dto)
      throws Exception {
  ...
  public ApiResponse<Void> deleteGroup(
      @RequestAttribute("sessionId") String sessionId, @PathVariable String groupName)
      throws Exception {
